...
export default function B2bSliderListePage() {
    ...
    const fetchData = async () => {
        try {
            setIsLoading(true);
            const response = await api.get(API_ENDPOINTS.b2bSliderListe);
                        ...
                        {isLoading ? (
                            ...
                            table.getRowModel().rows.map((row) => (
                                <TableRow
                                    ...
                                    onClick={() => router.push(`/b2b-slider/${row.original.id}`)}
